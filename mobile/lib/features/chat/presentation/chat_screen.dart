...
class ChatScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final childEntity = child is ChildEntity ? child : null;

    return BlocProvider(
      create: (_) => ChatBloc(chatRepository)..add(ChatLoadHistoryRequested(childEntity?.id)),
      child: _ChatView(child: childEntity, showAppBar: showAppBar),
    );
  }
}
